package com.kinvey.tutorials.userlogin.authentication;
...
public class KinveyAccountAuthenticator extends AbstractAccountAuthenticator {
	...
	private static final String TAG = "KinveyAuth";
	...
	public KinveyUser login(String username, String password) {
			try {
